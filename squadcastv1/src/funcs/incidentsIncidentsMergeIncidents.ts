...
export function incidentsIncidentsMergeIncidents(
  ...
  Result<
    operations.IncidentsMergeIncidentsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.IncidentsMergeIncidentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/incidents/merge")();
  ...
  const context = {
    ...
    operationID: "Incidents_mergeIncidents",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.IncidentsMergeIncidentsResponse$inboundSchema),
