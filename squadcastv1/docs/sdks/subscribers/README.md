...
<!-- UsageSnippet language="typescript" operationID="StatusPages_deleteSubscriberById" method="delete" path="/v4/statuspages/{statuspageID}/subscribers/{subscriberID}" -->
```typescript
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.StatusPagesDeleteSubscriberByIdRequest](../../models/operations/statuspagesdeletesubscriberbyidrequest.md)                                                         | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.StatusPagesDeleteSubscriberByIdResponse](../../models/operations/statuspagesdeletesubscriberbyidresponse.md)\>**
